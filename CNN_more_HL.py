...
From the command line, this file can be ran using:
    python CNN_more_HL.py <parameter_file>
...
def write_save_data():
    ...
    folder = pm.save_path + 'RUN {} moreHL at {}/'.format(pm.filename_run, filename_time);
...
if __name__ == '__main__':
    ...
    try:
        os.mkdir(pm.tb_logs_path + pm.filename_run + ' moreHL')
