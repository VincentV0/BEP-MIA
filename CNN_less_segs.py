...
From the command line, this file can be ran using:
    python CNN_less_segs.py <parameter_file>
...
def write_save_data():
    ...
    folder = pm.save_path + 'RUN {} less segs at {}/'.format(pm.filename_run, filename_time);
...
if __name__ == '__main__':
    ...
    try:
        os.mkdir(pm.tb_logs_path + pm.filename_run + "_less_segs")
